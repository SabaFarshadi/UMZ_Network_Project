...
class Ui_ConnectingWindow(object):
    def setupUi(self, ConnectingWindow):
        ...
        self.bt1 = Button(ConnectingWindow,100,100,1)
        self.bt2 = Button(ConnectingWindow,200,100,1)
        self.bt3 = Button(ConnectingWindow,100,200,0)
        self.bt4 = Button(ConnectingWindow,200,200,1)
    ...
    def retranslateUi(self, ConnectingWindow):
        ...
        ConnectingWindow.setWindowTitle(_translate("ConnectingWindow", "MainWindow"))
