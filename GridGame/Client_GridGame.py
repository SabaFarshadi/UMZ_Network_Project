...
class Ui_ConnectingWindow(object):
    ...
    def sendData(self):
        self.message = (1,0,0,1)
        self.net.send(self.message)
        self.serverStatus = self.net.get()
    ...
    def setupUi(self, ConnectingWindow):
        ...
        self.bt1 = Button(ConnectingWindow,100,100,self.serverStatus[0])
        self.bt2 = Button(ConnectingWindow,200,100,self.serverStatus[1])
        self.bt3 = Button(ConnectingWindow,100,200,self.serverStatus[2])
        self.bt4 = Button(ConnectingWindow,200,200,self.serverStatus[3])
    ...
    def retranslateUi(self, ConnectingWindow):
        ...
        ConnectingWindow.setWindowTitle(_translate("ConnectingWindow", "CLIENT"))
